...
gallery/digitalScroll/1.0/index
 ...
 **/
KISSY.add('gallery/digitalScroll/1.0/index',function (S, DOM, Base, Anim) {
	'use strict';
    ...
    S.extend(DigitalScroll, Base, /** @lends DigitalScroll.prototype*/{
    	...
    	ATTRS : /** @lends DigitalScroll*/{
	        ...
	        /**
	         * @attribute exec
	         * @description 初始化执行配置，只有在data有值时生效（auto：是否自动执行，默认为true；delay：执行延迟时间，默认为100
	         * @type Object
	         */
	        exec: {
	        	value: {
...
}, {requires:['dom', 'base', 'gallery/layer-anim/1.0/']});
